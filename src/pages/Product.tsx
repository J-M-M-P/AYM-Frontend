        ...
        <>
            <div className="container-fluid">
                ...
                <div className="container" style={{ marginTop: "calc(9/21 * 105vw)" }}>
                    ...
                    <div className="row d-sm-block d-md-none">
                        <div className="col text-center">
                            ...
                            <p className="" style={{ fontSize: "14px" }}>
                                Med en sublim blanding af æstetik og håndværk inviterer vores smykker dig ind i en
                                verden af tidsløs elegance og personlig stil. Hvert stykke er nøje udformet med en
                                forfinet sans for detaljer og en lidenskab for at skabe unikke kunstværker, der
                                udstråler skønhed og karakter.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="row row-cols-4 row-gap-5" style={{ marginBottom: "10rem" }}>
